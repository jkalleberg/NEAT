...
def index_ref(n_lines, f, ref_inds, prev_r, prev_p):
...
def parse_vcf(vcf_filename, ref_name, targ_regions_FL, out_file, out_bool, vcf_out):
    v_hashed = {}
    v_pos_hash = {}
    v_alts = {}
    v_cov = {}
    ...
    return (v_hashed, v_alts, v_cov, v_af, v_qual, v_targ_len, n_below_min_r_len, line_unique, var_filtered, var_merged, hash_coll)
...
def main():   
    ...
    index_ref(n_lines, f, ref_inds, prev_r, prev_p)
    ...
    read_mappability_track(maptrack, n, min_read_len)
    ...
    for n_RI in ref_inds:
        ...
        #	Parse relevant targeted regions
        #
        targ_regions_fl = parse_target_regions(bedfile, ref_name, MAX_VAL)
